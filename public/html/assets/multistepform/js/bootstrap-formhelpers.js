  ...
  BFHDatePicker.prototype = {
    ...
    initCalendar: function() {
      ...
      this.$element
        ...
        .on('click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api', '.bfh-datepicker-calendar > table.calendar .year > .previousTen', BFHDatePicker.prototype.previousTenYear)
        .on('click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api', '.bfh-datepicker-calendar > table.calendar .year > .nextTen', BFHDatePicker.prototype.nextTenYear)
    ...
    previousTenYear: function () {
      ...
      $parent.data('year', Number($parent.data('year')) - 10);
